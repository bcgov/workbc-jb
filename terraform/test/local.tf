...
locals {
  ...
  df_conn			       = "Server=${aws_rds_cluster.postgres_jbnewfinal.endpoint};Database=WorkBC_JobBoard;Username=${local.db_creds.username};Password=${local.db_creds.newjbpost}"
