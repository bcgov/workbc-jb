        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupKey = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true),
                    GroupLabel = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
                    GroupOrder = table.Column<short>(type: "smallint", nullable: false),
                    IsTotal = table.Column<bool>(type: "bit", nullable: false),
                    ReportKey = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: true),
                    StatLabel = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
