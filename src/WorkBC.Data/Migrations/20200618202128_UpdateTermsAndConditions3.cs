...
{
    public partial class UpdateTermsAndConditions3 : Migration
    {
...
<p>If you do not agree to be bound by these Terms of Use, you must not access this website or use the job board.</p>' WHERE [Name] = 'jbAccount.registration.termsOfUseText'");
            ...
            migrationBuilder.Sql(
                @"update SystemSettings set [value] = 'WorkBC Employment Services Centres support you in finding a job and keeping it.' where [name] = 'jbAccount.dashboard.resource2Body'");
