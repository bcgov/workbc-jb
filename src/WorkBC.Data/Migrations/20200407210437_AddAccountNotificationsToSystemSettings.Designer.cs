...
namespace WorkBC.Data.Migrations
{
    ...
    [Migration("20200407210437_AddAccountNotificationsToSystemSettings")]
    partial class AddAccountNotificationsToSystemSettings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkBC.Data.Model.JobBoard.JobSeekersByLocation", b =>
                {
            ...
            modelBuilder.Entity("WorkBC.Data.Model.JobBoard.JobSeekersByLocationPeriod", b =>
                {
                    b.Property<int>("WeeklyPeriodId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("WeeklyPeriodId");

                    b.ToTable("JobSeekersByLocationPeriods");
                });
            ...
            modelBuilder.Entity("WorkBC.Data.Model.JobBoard.JobsByRegion", b =>
                {
                    b.Property<int>("WeeklyPeriodId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WorkBC.Data.Model.JobBoard.JobsByRegionPeriod", b =>
                {
                    b.Property<int>("WeeklyPeriodId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WorkBC.Data.Model.JobBoard.WeeklyPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WorkBC.Data.Model.JobBoard.JobSeekersByLocation", b =>
                {
                    b.HasOne("WorkBC.Data.Model.JobBoard.WeeklyPeriod", "WeeklyPeriod")
                        .WithMany()
