...
{
    public partial class RecommendedJobsCopyUpdates : Migration
    {
...
<p class=""no-recommended-jobs""> To increase the number of recommendations, you can either <a href=""#/saved-jobs"">save a job</a>, <a href=""#/personal-settings#location"">change your city</a> or <a href=""#/personal-settings"">add group(s) that you self-identify as</a> in your <em>Personal Settings</em>. </p>',
