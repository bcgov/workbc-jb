...
</html>', N'Job alert email template / HTML version. {0} = firstName, {1} = frequency, {2} = jobAlertTitle, {3} = notificationUrl, {4} = emailSubject.', 5, 1, CAST(N'2020-07-07T12:38:01.4238405' AS DateTime2),
...
INSERT [dbo].[SystemSettings] ([Name], [Value], [Description], [FieldType], [ModifiedByAdminUserId], [DateUpdated], [DefaultValue]) VALUES (N'shared.filters.educationTitle', N'Education required', N'Main title for the education filter', 1, 1, CAST(N'2020-07-07T11:11:00.3220367' AS DateTime2), N'Education')
");
        }
