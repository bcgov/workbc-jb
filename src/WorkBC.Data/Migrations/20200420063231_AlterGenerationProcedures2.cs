...
{
    public partial class AlterGenerationProcedures2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                "INSERT INTO JobSeekerStatLabels ([Key],[Label],[IsTotal]) VALUES ('CFEM','Registration Email Confirmed',0)");
...
BEGIN TRY
	...
	BEGIN 
		...
		/*INSERT INTO dbo.JobSeekerStats
			(WeeklyPeriodId,[LabelKey],[RegionId],[Value])
		SELECT @PeriodId, 'NOAC', RegionId, COUNT(*) 
		FROM @JobSeekerData
