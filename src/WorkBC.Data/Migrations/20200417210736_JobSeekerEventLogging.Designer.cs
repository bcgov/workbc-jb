...
namespace WorkBC.Data.Migrations
{
    ...
    [Migration("20200417210736_JobSeekerEventLogging")]
    partial class JobSeekerEventLogging
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkBC.Data.Model.JobBoard.JobSeekerEvent", b =>
                {
                    ...
                    b.HasIndex("DateLogged", "EventTypeId");
            ...
            modelBuilder.Entity("WorkBC.Data.Model.JobBoard.ReportData.JobSeekerStat", b =>
                {
                    ...
                    b.Property<string>("ReportMetadataKey")
                        .HasColumnType("varchar(4)");

                    b.Property<int>("Value")
                        .HasColumnType("int");

                    b.HasKey("WeeklyPeriodId", "ReportMetadataKey");

                    b.HasIndex("ReportMetadataKey");

                    b.ToTable("JobSeekerStats");
                });

            modelBuilder.Entity("WorkBC.Data.Model.JobBoard.ReportData.JobSeekersByLocation", b =>
                {
                    b.Property<int>("WeeklyPeriodId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("WeeklyPeriodId", "RegionId");

                    b.ToTable("JobSeekersByLocation");
                });

            modelBuilder.Entity("WorkBC.Data.Model.JobBoard.ReportData.JobsByRegion", b =>
                {
                    b.Property<int>("WeeklyPeriodId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("JobsByRegion");
                });

            modelBuilder.Entity("WorkBC.Data.Model.JobBoard.ReportData.ReportMetadata", b =>
                {
            ...
            modelBuilder.Entity("WorkBC.Data.Model.JobBoard.ReportData.ReportPersistenceControl", b =>
                {
                    ...
                    b.HasKey("WeeklyPeriodId", "Report");
            ...
            modelBuilder.Entity("WorkBC.Data.Model.JobBoard.ReportData.JobSeekerStat", b =>
                {
                    b.HasOne("WorkBC.Data.Model.JobBoard.ReportData.ReportMetadata", "ReportMetadata")
                        .WithMany()
                        .HasForeignKey("ReportMetadataKey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
