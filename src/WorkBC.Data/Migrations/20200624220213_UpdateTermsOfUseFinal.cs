...
{
    public partial class UpdateTermsOfUseFinal : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
DELETE FROM [dbo].[SystemSettings] WHERE [Name] = 'jbAccount.registration.termsOfUseText'
GO
INSERT [dbo].[SystemSettings] ([Name], [DefaultValue], [Description], [FieldType], [ModifiedByAdminUserId], [DateUpdated]) VALUES (N'jbAccount.registration.termsOfUseText', N'<h4><strong>Introduction</strong></h4>
...
<p>You may use the job board either as an anonymous job seeker (""anonymous user"") or, if you would like to take advantage of additional services, you may set up a user account and become a registered job seeker (""registered user""). In either case, you will be bound by the Terms of Use, to the extent applicable.</p>
...
<h4><strong>Anonymous user</strong></h4>
...
<h4><strong>Registered user</strong></h4>
...
<h4><strong>Voluntary participation</strong></h4>
<p>Participation is voluntary. If you do not provide your personal information, you will not be able to create an account on the WorkBC Job Board. You may still use the WorkBC Job Board as an anonymous user to search for jobs, but you will not be able to access features associated with having an account (e.g. create job alerts).</p>
...
<p>The Province has no obligation to provide, or continue to provide, the job board service to you. All functionalities of the WorkBC Job Board are provided on an as available basis. Without limiting the generality of the foregoing and in addition to the <a href=""https://www2.gov.bc.ca/gov/content/home/disclaimer"" target=""_blank""><u>Warranty Disclaimer</u></a>, the Province makes no representations or warranties, express or implied, with respect to:</p>
<ul>
...
<p>The Province may at any time revoke your access to WorkBC Job Board if you use the Service other than for legitimately searching and applying for employment opportunities for your own personal purposes only.</p>
