...
{
    public partial class JobSeekerAccountViewModel
    {
    ...
    public partial class JobSeekerAccountViewModel : IMatrixReportViewModel
    {
        public List<HtmlString> TableHeadings { get; set; }
    }

    public partial class JobSeekerAccountViewModel : IMatrixDateRangeParams
    {
