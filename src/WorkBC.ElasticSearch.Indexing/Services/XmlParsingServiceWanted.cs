...
namespace WorkBC.ElasticSearch.Indexing.Services
{
    public class XmlParsingServiceWanted : XmlParsingServiceBase
    {
        ...
        /// <summary>
        /// Parses legacy TalentNeuron XML job data into an ElasticSearchJob.
        /// Innovibe JSON payloads are indexed by the PHP wanted indexer
        /// (WorkBC.Indexers.Innovibe.V2); this class no longer handles JSON.
        /// </summary>
